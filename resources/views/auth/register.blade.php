                                ...
                                <div class="nk-stepper-steps stepper-steps">
                                        ...
                                        <ul class="row g-3">
                                            ...
                                            <li class="col-6">
                                                <div
                                                    class="custom-control custom-control-sm custom-radio pro-control custom-control-full">
                                                    <input type="radio" class="custom-control-input"
                                                        name="employer_status" id="old_employer" value="old" required>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="ecs_number"
                                                            name="ecs_number" placeholder="Enter ECS Number" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                    ...
                                    <div class="nk-stepper-step">
                                        ...
                                        <div class="row g-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="contact_surname"
                                                            name="contact_surname" placeholder="Surname" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="contact_name">Middle Name</label>
                                                    <div class="form-control-wrap">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="contact_position"
                                                            name="contact_position" placeholder="Contact Company Position"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="company_phone"
                                                            name="company_phone" placeholder="Enter Contact Phone"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="contact_number"
                                                            name="contact_number" placeholder="Enter Contact NIN"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="nk-stepper-step">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="business_area">Business Type</label>
                                                    <div class="form-control-wrap">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="company_rcnumber">RC Number</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="company_rcnumber"
                                                            name="company_rcnumber" placeholder="RC Number" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="cac_reg_year">CAC Registration
                                                        Date</label>
                                                    <div class="form-control-wrap">
                                    ...
                                    <div class="nk-stepper-step">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="other_documents">Other Documents <span
                                                            class="text-danger">(PDF only)*</span></label>
                                                    <div class="form-control-wrap">
                                                        <input type="file" class="form-control" id="other_documents"
                                                            accept=".pdf" name="other_documents"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="cp1-card-number">New Password</label>
                                                    <div class="form-control-wrap">
