                    ...
                    <div class="col-lg-12" style="background-color: #ffffff;">
                        <nav class="navbar navbar-expand-lg" style="background-color: #ffffff;">
                            <a class="navbar-brand" href="index.html" style="text-decoration: none;">
                                <img style="height: 6vh;" src="{{asset('landing_assets/assets/css/animate.css')}}" alt="">
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="header-hero-content">
                            ...
                            <ul class="d-flex">
                                ...
                                <li><a href="#" rel="nofollow" class="main-btn wow fadeInLeftBig" data-wow-duration="1.3s"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-10">
                        <div class="px-5">
                            <div class="">
                                ...
                                <img src="{{asset('landing_assets/images/businessperson.png')}}" alt="">
                            </div>
                        </div>
                    </div> <!-- header image -->
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-image mt-50 wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <img class="app" src="{{asset('landing_assets/assets/images/cc.jpg')}}" alt="app">
                    </div> <!-- about image -->
                </div>
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInRightBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <a href="#" rel="nofollow" class="main-btn">Download
                            Certificates</a>
                    </div> <!-- about content -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6 col-md-9">
                    <div class="download-image mt-50 wow fadeInRightBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        <img class="" style="border-radius:25px;" src="{{asset('landing_assets/assets/images/nsgit .png')}}" alt="download">
